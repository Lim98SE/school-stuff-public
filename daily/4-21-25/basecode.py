...
while running: #GAME LOOP##################################################
    ...
    if key[KEY_SPACE]:
        ...
        BeamX_2 += 10 #handles how fast the beam moves to the right
        BeamY_2 = A * math.sin(B*(angle-C)) + D #handles the shape of the beam
        #------------------------------------------
        A = 400
        B = 2
        C = 0
    ...
    if isShooting:
        ...
        pygame.draw.circle(screen, (0, 0, 180), (int(BeamX_2), int(BeamY_2)), 5) #draw beam
